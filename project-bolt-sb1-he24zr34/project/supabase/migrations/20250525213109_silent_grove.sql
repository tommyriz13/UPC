/*
  # Fix match status update and verification

  1. Changes
    - Add verification_status to match_results
    - Update handle_match_result_approval function
    - Add function to verify match results
    - Add admin policy for match updates
