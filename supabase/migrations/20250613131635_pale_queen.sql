...
-- Drop ALL existing policies for editions table to avoid conflicts
DO $$ 
BEGIN
  -- Drop all policies on editions table
  ...
  DROP POLICY IF EXISTS "Competitions are viewable by everyone" ON editions;
  DROP POLICY IF EXISTS "Only admins can modify competitions" ON editions;
EXCEPTION
  WHEN undefined_table THEN NULL;
END $$;

-- Policies for editions
CREATE POLICY "Editions viewable by everyone"
  ON editions FOR SELECT
  USING (true);

CREATE POLICY "Admins can modify editions"
  ON editions FOR ALL
  USING (
    EXISTS (
...
CREATE POLICY "League matches viewable by everyone"
  ON matches_league FOR SELECT
  USING (true);

CREATE POLICY "Admins can modify league matches"
...
CREATE POLICY "Admins can modify cup matches"
...
CREATE POLICY "Champions matches viewable by everyone"
  ON matches_champions FOR SELECT
  USING (true);

CREATE POLICY "Admins can modify champions matches"
...
CREATE POLICY "Admins can modify league standings"
...
CREATE POLICY "Champions standings viewable by everyone"
  ON standings_champions_groups FOR SELECT
  USING (true);

CREATE POLICY "Admins can modify champions standings"
...
CREATE POLICY "Admins can modify league stats"
...
CREATE POLICY "Cup stats viewable by everyone"
  ON stats_cup FOR SELECT
  USING (true);

CREATE POLICY "Admins can modify cup stats"
...
CREATE POLICY "Champions stats viewable by everyone"
  ON stats_champions FOR SELECT
  USING (true);

CREATE POLICY "Admins can modify champions stats"
